...
if (Get-Command py -ErrorAction SilentlyContinue) { py -3 ".\PATCH184_apply.py" }
else { python ".\PATCH184_apply.py" }
if ($LASTEXITCODE -ne 0) { exit $LASTEXITCODE }

Write-Host ""
Write-Host "Patch184 VERIFIED and applied." -ForegroundColor Green
