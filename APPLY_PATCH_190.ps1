...
if (Get-Command py -ErrorAction SilentlyContinue) { py -3 ".\PATCH190_apply.py" } else { python ".\PATCH190_apply.py" }
if ($LASTEXITCODE -ne 0) { exit $LASTEXITCODE }
Write-Host ""
Write-Host "Patch190 applied and verified." -ForegroundColor Green
