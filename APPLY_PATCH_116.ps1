...
Copy-Item (Join-Path $PSScriptRoot "lib\core\document_text_catalog.dart") (Join-Path $project "lib\core\document_text_catalog.dart") -Force
Copy-Item (Join-Path $PSScriptRoot "lib\screens\batch_statement_pdf_dialog.dart") (Join-Path $project "lib\screens\batch_statement_pdf_dialog.dart") -Force
