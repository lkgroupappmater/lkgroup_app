...
if (Get-Command py -ErrorAction SilentlyContinue) { py -3 ".\PATCH183R_apply.py" }
else { python ".\PATCH183R_apply.py" }
if ($LASTEXITCODE -ne 0) { exit $LASTEXITCODE }
Write-Host ""
Write-Host "Patch183R applied." -ForegroundColor Green
