...
class ExcelImportService {
    ...
    if (isBaseUpdate) {
      ...
      return ExcelImportResult(
        ...
        message:
            ...
            '$routeLabel 경로의 기준 원본·배송·할인·선공유 규칙을 갱신했습니다. 기존 항차 번호와 정산은 유지됩니다.',
      );
    }
  ...
  Future<void> _saveWorkbookTemplate({
    ...
    if (voyage == '00') {
      await SupabaseService.client.from('shipment_excel_base_templates').upsert({
        'route_key': routeKey, 'route_label': routeLabel, 'file_name': fileName,
        'storage_path': path, 'active': true, 'prefer_for_export': true,
        'source_sha256': null, 'policy_summary': <String, dynamic>{},
  ...
  Future<int> _importLocalDeliveryProfiles(
    ...
    final splitStyles = <String, Map<int, _DeliveryRowStyle>>{};
