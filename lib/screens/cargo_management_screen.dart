...
class _CargoManagementScreenState extends State<CargoManagementScreen> {
  ...
  Future<void> _openManagementMenu() async {
      ...
      builder: (sheetContext) => SafeArea(
        child: Column(mainAxisSize: MainAxisSize.min, children: [
          ...
          ListTile(
              ...
              onTap: () => Navigator.pop(sheetContext, 'notice')),
          ...
          if (_isAdmin)
            ListTile(
                ...
                onTap: () => Navigator.pop(sheetContext, 'exchange')),
        ]),
      ),
    );
    ...
    Navigator.push<void>(context, MaterialPageRoute(builder: (_) {
      if (choice == 'schedule') {
        return ScheduleManagementScreen(user: widget.user);
      }
      if (choice == 'excel') return const ExcelUploadScreen();
      if (choice == 'exchange') return const ExchangeRateScreen();
        ...
        children: [
          ...
          if (_isAdmin) ...[
            ...
            OutlinedButton.icon(
              ...
              label: const Text('일정·공지·엑셀·환율 관리'),
            ),
          ],
        ],
      );
