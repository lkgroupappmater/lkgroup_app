...
class _NoticeManagementScreenState extends State<NoticeManagementScreen> {
  final List<Map<String, String>> _items = [
    {
      'title': '2026년 하반기 운송 일정 안내',
      'date': '2026-06-20',
      'content': '하반기 노선별 접수 마감일과 도착 예정일을 확인해 주세요.'
    },
    {
      'title': '통관 서류 제출 안내',
      'date': '2026-06-15',
      'content': '화물 접수 전 필요한 통관 서류를 준비해 주세요.'
    },
  ];
  String _today() {
  ...
  void _editor({Map<String, String>? existing, int? index}) {
    final title = TextEditingController(text: existing?['title'] ?? ''),
        content = TextEditingController(text: existing?['content'] ?? '');
    showDialog<void>(
        context: context,
            ...
            return Card(
                child: ListTile(
                    ...
                    trailing: Wrap(children: [
                      IconButton(
                          onPressed: () =>
                              _editor(existing: item, index: index),
